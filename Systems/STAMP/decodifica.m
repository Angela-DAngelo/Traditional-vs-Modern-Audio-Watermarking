addpath(genpath('E:\Ricerca\2026\audio_watermarking\AudioWatermarking\00_final_test\02a_ABA\'));
clear all;
...
%outputExcel = ['results_stampv1_attacked_' dataset_name '.xlsx'];
outputExcel = ['results_stampv1_nowm_' dataset_name '.xlsx'];
...
% leggi marchio
excelFile = ['watermark_' dataset_name '.xlsx'];  % Sostituisci con il tuo file
