...
% PROFILES PARAMETERS------------------------------------------------------
MSSDH.Ns = [16 26 30 30 30 20 64 64 64 26 16];
MSSDH.Nf = [4 8 4 6 8 8 4 4 4 9 16]; %Nf(3) modificato da 6 a 4 per inserire più bits
MSSDH.fmin = [1400 1400 400 400 400 1400 1400 1400 1400 1400 1400];
...
%PROFILE 3------------------------------------------------------------------
% With profile 3, you can select the number of bits you want to embed in 
% the audio. The watermark energy is preset; to modify it, adjust the 
% corresponding MSSDH values in the top of the files.


% X=120;
% rc =  1/2;
% Tmarchio=4; % Duration of the watermark in seconds; if you change it,
%             % change it also in main file (STAMP.m)
% 
% 
% Ns_freq   = MSSDH.Nf(3);
% Nslots    = MSSDH.Ns(3);
% Kmax      = floor(length(ind_freqs_all) / Ns_freq);    
% T         = Dati_code.constlen_p - 1;                  
% 
